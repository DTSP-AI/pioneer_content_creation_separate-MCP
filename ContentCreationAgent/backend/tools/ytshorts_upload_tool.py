...
class YouTubeShortsUploadTool(BaseUploadTool):
    """
    ...
    async def _arun(
        ...
        try:
            ...
            if not settings.YOUTUBE_CLIENT_ID:
                error_msg = "YouTube credentials not configured. Please set YOUTUBE_CLIENT_ID and YOUTUBE_CREDENTIALS_FILE in environment variables."
